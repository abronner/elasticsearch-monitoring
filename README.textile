...
* @scripts/elasticsearch-nodes-stats.sh@ needs to run at the beginning of each new month to create the index for that month and shift the nodes_stats alias.

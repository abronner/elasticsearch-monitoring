...
This is an elegant way to monitor your elasticsearch cluster. 
...
Install "http://www.elasticsearch.org/overview/kibana/installation/":kibana and load @dashboards/monitoring-dashboard.json@. 
...
Two production nodes, sampling nodes stats every 5 minutes:
